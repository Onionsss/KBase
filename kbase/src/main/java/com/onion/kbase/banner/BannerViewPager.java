...
import com.onion.kbase.R;
import com.onion.kbase.banner.adapter.BannerPagerAdapter;
import com.onion.kbase.banner.annotation.AIndicatorGravity;
import com.onion.kbase.banner.annotation.AIndicatorSlideMode;
import com.onion.kbase.banner.annotation.AIndicatorStyle;
import com.onion.kbase.banner.annotation.APageStyle;
import com.onion.kbase.banner.annotation.ATransformerStyle;
import com.onion.kbase.banner.annotation.Visibility;
import com.onion.kbase.banner.constants.IndicatorGravity;
import com.onion.kbase.banner.constants.PageStyle;
import com.onion.kbase.banner.holder.HolderCreator;
import com.onion.kbase.banner.holder.ViewHolder;
import com.onion.kbase.banner.indicator.IIndicator;
import com.onion.kbase.banner.indicator.IndicatorView;
import com.onion.kbase.banner.manager.BannerManager;
import com.onion.kbase.banner.manager.BannerOptions;
import com.onion.kbase.banner.provider.ViewStyleSetter;
import com.onion.kbase.banner.transform.PageTransformerFactory;
import com.onion.kbase.banner.transform.pagestyle.ScaleInTransformer;
import com.onion.kbase.banner.utils.BannerUtils;

import java.util.ArrayList;
import java.util.List;

import static com.onion.kbase.banner.adapter.BannerPagerAdapter.MAX_VALUE;
...
public class BannerViewPager<T, VH extends ViewHolder> extends RelativeLayout implements
    ...
    public void onPageSelected(int position) {
        ...
        if (mList.size() > 0 && isCanLoop() && position == 0) {
            position = Integer.MAX_VALUE / 2 - ((Integer.MAX_VALUE / 2) % mList.size()) + 1;
    ...
    private void initIndicatorGravity() {
        ...
        switch (mBannerManager.bannerOptions().getIndicatorGravity()) {
            case IndicatorGravity.CENTER:
                ...
                break;
            case IndicatorGravity.START:
                layoutParams.addRule(RelativeLayout.ALIGN_PARENT_START);
                break;
            case IndicatorGravity.END:
    ...
    private void initPageStyle() {
        switch (mBannerManager.bannerOptions().getPageStyle()) {
            case PageStyle.MULTI_PAGE:
                setMultiPageStyle(false, ScaleInTransformer.MAX_SCALE);
                break;
            case PageStyle.MULTI_PAGE_OVERLAP:
                setMultiPageStyle(true, ScaleInTransformer.DEFAULT_MIN_SCALE);
                break;
            case PageStyle.MULTI_PAGE_SCALE:
                setMultiPageStyle(false, ScaleInTransformer.DEFAULT_MIN_SCALE);
                break;
        }
    }
