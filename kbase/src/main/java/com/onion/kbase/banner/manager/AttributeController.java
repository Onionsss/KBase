package com.onion.kbase.banner.manager;
...
public class AttributeController {
    ...
    private void initBannerAttrs(TypedArray typedArray) {
        ...
        int scrollDuration = typedArray.getInt(R.styleable.BannerViewPager_bvp_scroll_duration, BannerOptions.DEFAULT_SCROLL_DURATION);
