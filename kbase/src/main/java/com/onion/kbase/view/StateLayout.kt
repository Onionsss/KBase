...
class StateLayout @JvmOverloads constructor(
    ...
    private var empty_img: Int = R.drawable.car_service_empty
    ...
    init {
        ...
        try {
            emptyLayout = attributes.getResourceId(R.styleable.StateLayout_empty_layout, R.layout.widget_empty_page)
            empty_img = attributes.getResourceId(R.styleable.StateLayout_empty_img,R.drawable.car_service_empty)
            showNetErrorFirst = attributes.getBoolean(R.styleable.StateLayout_showNetErrorFirst,false)
            empty_text = attributes.getString(R.styleable.StateLayout_empty_text)
            errorLayout = attributes.getResourceId(R.styleable.StateLayout_error_layout, R.layout.widget_error_page)
            networkLayout = attributes.getResourceId(R.styleable.StateLayout_network_layout, R.layout.widget_nonetwork_page)
            isShowLoading = attributes.getBoolean(R.styleable.StateLayout_isShowLoding,true)
        } finally {
            attributes.recycle()
        }
    }
